...
// user triggers, so the description carries "HeliosAE on the web" + URL.
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in HeliosAE on the web. See ${CCR_TERMS_URL}`,
