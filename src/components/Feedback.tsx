      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              HeliosAE&apos;s functionality (eg. to reduce the risk of bugs
