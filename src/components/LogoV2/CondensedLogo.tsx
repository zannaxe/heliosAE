...
export function CondensedLogo() {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text bold={true} color="cyan">HeliosAE <Text color="yellow">⚡</Text></Text>;
    $[8] = t5;
  } else {
    t5 = $[8];
  }
  ...
  const t6a = 'AERIS Nexus — Personal AI System';
  let t7;
  ...
  if ($[23] !== t10 || $[24] !== t11 || $[25] !== t6 || $[26] !== t7 || $[27] !== t9) {
    t12 = <OffscreenFreeze><Box borderStyle="round" borderColor="cyan" paddingX={2} paddingY={0} flexDirection="row" gap={2} alignItems="center"><Box flexDirection="column" alignItems="center"><Text color="cyan">•</Text>{t4}<Text color="cyan">•</Text></Box><Box flexDirection="column"><Text bold={true} color="cyan">HeliosAE <Text color="yellow">⚡</Text></Text><Text dimColor={true}>{t6a}</Text><Box marginTop={1}>{t6}</Box>{t7}{t9}{t10}{t11}</Box></Box></OffscreenFreeze>;
    $[23] = t10;
    $[24] = t11;
    $[25] = t6;
    $[26] = t7;
