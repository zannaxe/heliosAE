...
/**
 * Resolve HeliosAE-specific path patterns for sandbox-runtime.
 *
 * HeliosAE uses special path prefixes in permission rules:
...
/**
 * Convert HeliosAE settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where HeliosAE started)
