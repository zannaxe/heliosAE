...
// Always ask when HeliosAE tries to edit its own config files
 ...
 * This is a per-user temporary directory used by HeliosAE for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by HeliosAE)
