...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when HeliosAE was first started on this machine
  ...
  // HeliosAE usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first HeliosAE OAuth token
  ...
  // HeliosAE hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
