...
export const DESCRIPTION = 'Get or set HeliosAE configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set HeliosAE configuration settings.

  View or change HeliosAE settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
