...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.ISSUES_EXPLAINER':
      JSON.stringify('report the issue at https://aeris-nexus.dev/issues'),
    'MACRO.PACKAGE_URL': JSON.stringify('@aeris-nexus/helios'),
...
// @ant/computer-use-input exports
export const ComputerUseInput = new Proxy({}, { get: () => noop });
export const ComputerUseInputAPI = new Proxy({}, { get: () => noop });
// @ant/computer-use-swift exports
export const ComputerUseAPI = new Proxy({}, { get: () => noop });
